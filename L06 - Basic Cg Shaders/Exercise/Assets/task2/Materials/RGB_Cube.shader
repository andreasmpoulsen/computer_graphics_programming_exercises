	   ...
	   Pass {
		  ...
		  vertexOutput vert(float4 vertexPos : POSITION)
			  // vertex shader 
		   {
			  ...
			  //Grey:
			  //output.col = float4((vertexPos.x + vertexPos.y + vertexPos.z) / 3, (vertexPos.x + vertexPos.y + vertexPos.z) / 3, (vertexPos.x + vertexPos.y + vertexPos.z) / 3, 1.0);
			  //Subtractive CMY:
			  output.col = float4(0.5 - vertexPos.x, 0.5 - vertexPos.y, 0.5 - vertexPos.z, 1.0);
